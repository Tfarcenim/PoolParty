...
public abstract class FloatingEntity extends Entity {
    ...
    private static final EntityDataAccessor<Integer> DATA_ID_HURT = SynchedEntityData.defineId(FloatingEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Integer> DATA_ID_HURTDIR = SynchedEntityData.defineId(FloatingEntity.class, EntityDataSerializers.INT);
    private static final EntityDataAccessor<Float> DATA_ID_DAMAGE = SynchedEntityData.defineId(FloatingEntity.class, EntityDataSerializers.FLOAT);

    private static final EntityDataAccessor<ItemStack> DATA_ITEM = SynchedEntityData.defineId(FloatingEntity.class, EntityDataSerializers.ITEM_STACK);
    ...
    private SwimmingTubeEntity.Status status;
    private SwimmingTubeEntity.Status oldStatus;
    ...
    public FloatingEntity(EntityType<? extends FloatingEntity> type,Level level, double x, double y, double z, ItemStack stack) {
        this(type, level);
        this.setPos(x, y, z);
        this.xo = x;
        this.yo = y;
